...
- File extension: `.esql`
- For ESQL development standards, refer to [.github/instructions/esql.instructions.md](.github/instructions/esql.instructions.md)
...
- For Message Flow development standards, refer to [.github/instructions/msgflow.instructions.md](.github/instructions/msgflow.instructions.md)
